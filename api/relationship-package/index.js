/**
 * Public Relationship Package adapter.
 * GET /api/relationship-package
 */
const fs = require("fs");
...
const DATA_SOURCE_ID = "37d60f0801b581dbab71000b6f3650b1";
...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    return sendJson(res, 500, { error: "ไม่สามารถโหลดแพ็กเกจ Relationship Package ได้ในขณะนี้" });
  }
};
